...
#map2 = affine_map<(d0) -> (2300, d0 * 32 + 32)>
#map3 = affine_map<(d0) -> (2600, d0 * 32 + 32)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func.func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %5 = memref.cast %2 : memref<2000x2300xf64> to memref<?x2300xf64>
    ...
    affine.for %arg2 = 0 to 63 {
      affine.for %arg3 = 0 to 72 {
        affine.for %arg4 = 0 to 82 {
          affine.for %arg5 = #map0(%arg2) to min #map1(%arg2) {
            affine.for %arg6 = #map0(%arg4) to min #map3(%arg4) {
